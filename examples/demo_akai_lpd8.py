    ...
    config = ControllerConfig(
        banks={
            ...
            "bank_1": BankConfig(
                ...
                controls={
                    "pad_1": ControlConfig(type=ControlType.TOGGLE, on_color="red"),
                    "pad_2": ControlConfig(type=ControlType.TOGGLE, on_color="orange"),
                    "pad_3": ControlConfig(type=ControlType.TOGGLE, on_color="yellow"),
                    "pad_4": ControlConfig(type=ControlType.TOGGLE, on_color="green"),
                    "pad_5": ControlConfig(type=ControlType.TOGGLE, on_color="cyan"),
                    "pad_6": ControlConfig(type=ControlType.TOGGLE, on_color="blue"),
                    "pad_7": ControlConfig(type=ControlType.TOGGLE, on_color="purple"),
                    "pad_8": ControlConfig(type=ControlType.TOGGLE, on_color="magenta"),
                },
            ),
            ...
            "bank_2": BankConfig(
                ...
                controls={
                    "pad_1": ControlConfig(type=ControlType.TOGGLE, on_color="red"),
                    "pad_2": ControlConfig(type=ControlType.TOGGLE, on_color="red"),
                    "pad_3": ControlConfig(type=ControlType.TOGGLE, on_color="orange"),
                    "pad_4": ControlConfig(type=ControlType.TOGGLE, on_color="orange"),
                    "pad_5": ControlConfig(type=ControlType.TOGGLE, on_color="yellow"),
                    "pad_6": ControlConfig(type=ControlType.TOGGLE, on_color="yellow"),
                    "pad_7": ControlConfig(type=ControlType.TOGGLE, on_color="pink"),
                    "pad_8": ControlConfig(type=ControlType.TOGGLE, on_color="pink"),
                },
            ),
            ...
            "bank_3": BankConfig(
                ...
                controls={
                    "pad_1": ControlConfig(type=ControlType.MOMENTARY, on_color="cyan"),
                    "pad_2": ControlConfig(type=ControlType.MOMENTARY, on_color="cyan"),
                    "pad_3": ControlConfig(type=ControlType.MOMENTARY, on_color="blue"),
                    "pad_4": ControlConfig(type=ControlType.MOMENTARY, on_color="blue"),
                    "pad_5": ControlConfig(type=ControlType.MOMENTARY, on_color="teal"),
                    "pad_6": ControlConfig(type=ControlType.MOMENTARY, on_color="teal"),
                    "pad_7": ControlConfig(type=ControlType.MOMENTARY, on_color="green"),
                    "pad_8": ControlConfig(type=ControlType.MOMENTARY, on_color="green"),
                },
            ),
            ...
            "bank_4": BankConfig(
                toggle_mode=True,
                controls={
                    "pad_1": ControlConfig(type=ControlType.TOGGLE, on_color="rgb(32, 32, 32)"),
                    "pad_2": ControlConfig(type=ControlType.TOGGLE, on_color="rgb(64, 64, 64)"),
                    "pad_3": ControlConfig(type=ControlType.TOGGLE, on_color="rgb(96, 96, 96)"),
                    "pad_4": ControlConfig(type=ControlType.TOGGLE, on_color="rgb(128, 128, 128)"),
                    "pad_5": ControlConfig(type=ControlType.TOGGLE, on_color="rgb(160, 160, 160)"),
                    "pad_6": ControlConfig(type=ControlType.TOGGLE, on_color="rgb(192, 192, 192)"),
                    "pad_7": ControlConfig(type=ControlType.TOGGLE, on_color="rgb(224, 224, 224)"),
                    "pad_8": ControlConfig(type=ControlType.TOGGLE, on_color="white"),
                },
            ),
        },
    )
